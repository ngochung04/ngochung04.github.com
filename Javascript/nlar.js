...
app.controller("myController", function ($scope) {
  ...
  $scope.cv = "Công việc";
  $scope.job1 = "GMO-z.com RUNSYSTEM";

  $scope.contact = "Thông tin liên lạc";
  $scope.contact1 = "dangngochung0401@gmail.com";
  $scope.contact2 = "fb.com/ngochung0401";
  ...
  $scope.modal4 = "Email";
  $scope.modal5 = "Sms";
  $scope.linkfb = "https://fb.com/ngochung0401";
  $scope.linkzl = "";
  $scope.linksc = "";
